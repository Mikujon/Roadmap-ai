  ...
  return (
    <>
      <style>{`
        ...
        .skeleton {
          background: linear-gradient(90deg, #F4F2EC 25%, #E5E2D9 50%, #F4F2EC 75%);
      ...
      <div style={{ padding: "28px 32px", fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: 10, marginBottom: 24 }}>
          {Array.from({ length: 7 }).map((_, i) => (
            <div key={i} style={{ background: "#fff", border: "1px solid #E5E2D9", borderRadius: 12, padding: "14px 16px" }}>
        ...
        <div style={{ background: "#fff", border: "1px solid #E5E2D9", borderRadius: 14, overflow: "hidden" }}>
          <div style={{ padding: "12px 16px", borderBottom: "1px solid #F4F2EC" }}>
            <div className="skeleton" style={{ width: 120, height: 12 }} />
          </div>
          {Array.from({ length: 5 }).map((_, i) => (
            <div key={i} style={{ display: "flex", alignItems: "center", gap: 16, padding: "14px 16px", borderBottom: "1px solid #F4F2EC" }}>
