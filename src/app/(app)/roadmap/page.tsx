...
const STATUS_CFG: Record<Status, { bg: string; border: string; color: string; dot: string; round: boolean; label: string }> = {
  released:    { bg: "#F0FDF4", border: "#006D6B", color: "#065F46", dot: "#006D6B", round: true,  label: "Released"    },
    ...
    <div style={{ padding: "24px 28px", fontFamily: "'DM Sans', system-ui, sans-serif", maxWidth: 1160 }}>
      ...
      {view === "list" && (
        <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
          {/* Released */}
          <div style={{ fontSize: 10, fontWeight: 800, letterSpacing: ".08em", textTransform: "uppercase", color: "#065F46", marginTop: 8, paddingBottom: 6, borderBottom: "2px solid #BBF7D0" }}>✓ Released</div>
          {released.map(item => (
            <div key={item.label} style={{ background: C.surface, border: "1px solid #BBF7D0", borderLeft: "3px solid #006D6B", borderRadius: 8, padding: "12px 14px", display: "flex", alignItems: "center", gap: 12 }}>
