...
export const C = {
  ...
  text2:    "#5C5A52",
  text3:    "#9E9C93",
  guardian: "var(--guardian, #006D6B)",
  guardianLight: "var(--guardian-light, #EDFAF9)",
  guardianBorder: "var(--guardian-border, #7FD4CF)",
  red:      "#DC2626", redBg: "#FEF2F2", redBorder: "#FECACA", redText: "#991B1B",
  amber:    "#D97706", amberBg: "#FFFBEB", amberBorder: "#FDE68A", amberText: "#92400E",
  green:    "#006D6B", greenBg: "#ECFDF5", greenBorder: "#A7F3D0", greenText: "#065F46",
...
const DEC_CFG: Record<DecPriority, { dot: string; badge: string; badgeBg: string; bg: string; borderLeft: string }> = {
  ...
  good:   { dot: C.green,  badge: "GOOD",   badgeBg: C.green,  bg: "rgba(0,109,107,.04)",  borderLeft: C.green  },
...
export function Row({ children, onClick, highlight }: { children: React.ReactNode; onClick?: () => void; highlight?: "r"|"a"|"g" }) {
  const bg = highlight === "r" ? "rgba(220,38,38,.04)" : highlight === "a" ? "rgba(217,119,6,.04)" : highlight === "g" ? "rgba(0,109,107,.04)" : undefined;
  return (
